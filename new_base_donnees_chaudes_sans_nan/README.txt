...
et pour les champs "action_open" et "action_click", qui sont les données chaudes, je supprime alors leurs valeurs nulles, enfin, il reste environ 2500 lignes dans le dataset.
